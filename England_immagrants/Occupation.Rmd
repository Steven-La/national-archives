...
category_map <- list(
  "Domestic & Personal Service" = c(
    ...
    "yeoman of the chamber", "yeoman of the crown", "innholder", "cook"
  ),
  "Manual Workers" = c(
    ...
    "swineherd", "wheeler", "shearman", "hellier", "roughmason", "pavier"
  ),
  "Merchants & Traders" = c(
  ...
  "Religious Orders" = c(
    ...
    "king's chaplain", "papal collector", "papal nuncio", "parson", "vagabond"
  ),
  "Nonworking" = c(
  ...
  "Craftsmen & Artisans" = c(
    ...
    "wool card maker", "furrier", "founder", "soapmaker", "souter", "cobbler", "capper",
    "skinner", "brewer", "beerbrewer", "barber", "cooper", "sawyer"
  ),
  "Legal & Clerical" = c(
    "clerk", "attorney", "scribe", "secretary", "notary", "proctor", "lawyer",
    "holy water clerk", "prothonotary", "king's latin secretary", "writer"
  ),
  "Medical" = c(
    "surgeon", "physician", "apothecary", "king's physician"
  ),
  "Military & Security" = c(
  ...
  "Performers, Artists, & Intellectuals" = c(
    "fiddler", "piper", "poet", "orator", "sculptor", "portrayer"
  ),
  "Other" = c(
